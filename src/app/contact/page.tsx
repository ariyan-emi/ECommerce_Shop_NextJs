    ...
    if (state) {
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 border h-screen">
                <div className="bg-gray-900 md:col-span-4 p-10 text-white ">
                    ...
                    <p className="mt-4 leading-7 text-gray-200">
                        Welcome to our world! We&apos;re thrilled you&apos;re here. Whether you have inquiries, ideas to
                        share, or
                        feedback to offer, we&apos;re all ears! Drop us a line through the form or email provided below,
                        and our
                        dedicated team will swiftly get back to you. Your input is valuable, and we&apos;re excited to
                        connect
                        with you!
                    </p>
		...
		c0.067,0.04,6.778,4.003,8.521,7.296C52.202,48.062,51.994,49.447,51.078,50.363z"
                    ...
                    <div className="flex items-center mt-5 md:h-1/6">
                        <svg className="h-12 mr-2 text-indigo-600 font-bold"
                            ...
                            <path d="M24 19V5" stroke="#4b41d8" strokeWidth="2" strokeLinecap="round"
                ...
                <form className="md:col-span-8 p-10 bg-white needs-validation" action="https://api.web3forms.com/submit" onSubmit={()=>{setstate(false)}}
        ...
        return (
            <div className="flex items-center justify-center h-screen">
                <div className="p-4 rounded shadow-lg ring ring-indigo-600/50 w-[80%] lg:w-[40%]">
