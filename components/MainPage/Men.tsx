...
export function Men() {
    ...
    const fetchInfo = () => {
        return axios.get('https://fakestoreapi.com/products/category/men\'s%20clothing').then((res) => setData(res.data));
    };

    useEffect(() => {
        fetchInfo();
    }, []);
    function getProductInfo(image:any,title:any,price:any,id:any){
        // course info
        const ProductInfo = {
            image: image,
            title: title,
                            ...
                            <div className="px-4 py-3 w-72">
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div className="ml-auto">
                                        <button onClick={(e)=>{
                                            e.preventDefault();
                                            getProductInfo(dataObj.image,dataObj.title,dataObj.price-10,dataObj.id)
                                        }}>
