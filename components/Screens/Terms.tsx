            ...
            <section className="py-16 lg:py-20 ">
                <div className="container">
                    <div className="grid items-center grid-cols-4 gap-6 lg:grid-cols-12">
                        <div
                            className="justify-center col-span-4 border-b border-b-wuiSlate-200 lg:col-span-8 lg:col-start-3">
                            <h1 className="pb-6 text-4xl font-medium text-wuiSlate-900">Terms &amp; Conditions</h1><p
                        ...
                        <div className="justify-center col-span-4 lg:col-span-8 lg:col-start-3"><p
                            ...
                            Terms of Use.</p><p className="pb-6 font-medium text-md">If you do not agree with all of
                            these terms of use, then you are expressly prohibited from using the site and/or the
                            marketplace offerings and you must discontinue use immediately.</p><p
                            className="pb-6 text-md">Supplemental terms and conditions or documents that may be posted
                            ...
                            continued use of the Site after the date such revised Terms of Use are posted.</p><p
                            className="pb-6 text-md">The information provided on the Site is not intended for
                            ...
                            applicable.</p><h2 className="pb-6 text-xl font-medium text-wuiSlate-800">Intellectual
                            ...
                            commercial purpose whatsoever, without our express prior written permission.</p><p
                            className="pb-6 text-md">Provided that you are eligible to use the Site, you are granted a
                            ...
                            the Content and the Marks.</p><h2
                            className="pb-6 text-xl font-medium text-wuiSlate-800">User Representations</h2><p
                            className="pb-6 text-md">By using the Site or the Marketplace Offerings, you represent and
                            warrant that: (1) you have the legal capacity and you agree to comply with these Terms of
                            Use; (2) you are not a minor in the jurisdiction in which you reside; (3) you will not
                            access the Site or the Marketplace Offerings through automated or non-human means, whether
                            through a bot, script or otherwise; (4) you will not use the Site for any illegal or
                            unauthorized purpose; and (5) your use of the Site or the Marketplace Offerings will not
                            violate any applicable law or regulation.</p><p className="pb-6 text-md">If you provide any
                            information that is untrue, inaccurate, not current, or incomplete, we have the right to
                            suspend or terminate your use and refuse any and all future use of the Site (or any portion
                            thereof).</p><p className="pb-6 text-md">You may not use the Site or the Marketplace
                            Offerings for any illegal or unauthorized purpose nor may you, in the use of Marketplace
                            Offerings, violate any laws. Among unauthorized Marketplace Offerings are the following:
                            intoxicants of any sort; illegal drugs or other illegal products; alcoholic beverages; games
                            of chance; and pornography or graphic adult content, images, or other adult products.
                            Postings of any unauthorized products or content may result in immediate termination of your
                            account and a lifetime ban from use of the Site.</p><p className="pb-6 text-md">We are a
                            service provider and make no representations as to the safety, effectiveness, adequacy,
                            accuracy, availability, prices, ratings, reviews, or legality of any of the information
                            ...
                            className="pb-6 text-md">We make every effort to display as accurately as possible the
                            colors, features, specifications, and details of the Marketplace Offerings available on the
                            Site. However, we do not guarantee that the colors, features, specifications, and details of
                            the Marketplace Offerings will be accurate, complete, reliable, current, or free of other
                            errors, and your electronic display may not accurately reflect the actual colors and details
                            of the products.</p><p className="pb-6 text-md">All descriptions or pricing of the
                            Marketplace Offerings are subject to change at any time without notice, at our sole
                            discretion. We reserve the right to discontinue any Marketplace Offerings at any time for
                            any reason. We do not warrant that the quality of any of the Marketplace Offerings purchased
                            by you will meet your expectations or that any errors in the Site will be corrected.</p><h2
                            className="pb-6 text-xl font-medium text-wuiSlate-800">Prohibited Activities</h2><p
                            className="pb-6 text-md">You may not access or use the Site for any purpose other than that
                            for which we make the Site available. The Site may not be used in connection with any
                            commercial endeavors except those that are specifically endorsed or approved by us.</p><h2
                            className="pb-6 text-xl font-medium text-wuiSlate-800">Contribution License</h2><p
                            className="pb-6 text-md">You and the Site agree that we may access, store, process, and use
                            any information and personal data that you provide following the terms of the Privacy Policy
                            and your choices (including settings). By submitting suggestions or other feedback regarding
                            the Site, you agree that we can use and share such feedback for any purpose without
                            compensation to you.</p><h2 className="pb-6 text-xl font-medium text-wuiSlate-800">Site
                            Management</h2><p className="pb-6 text-md">We reserve the right, but not the obligation, to:
                            (1) monitor the Site for violations of these Terms of Use; (2) take appropriate legal action
                            against anyone who, in our sole discretion, violates the law or these Terms of Use,
                            ...
                            or are in any way burdensome to our systems; and (5) otherwise manage the Site in a manner
                            designed to protect our rights and property and to facilitate the proper functioning of the
                            Site and the Marketplace Offerings.</p><h2
                            className="pb-6 text-xl font-medium text-wuiSlate-800">Term And Termination</h2><p
                            className="pb-6 text-md">These terms of use shall remain in full force and effect while you
                            use the site. Without limiting any other provision of these terms of use, we reserve the
                            right to, in our sole discretion and without notice or liability, deny access to and use of
                            the site and the marketplace offerings (including blocking certain ip addresses), to any
                            ...
                            law or regulation. We may terminate your use or participation in the site and the
                            marketplace offerings or delete any content or information that you posted at any time,
                            without warning, in our sole discretion.</p><h2
                            className="pb-6 text-xl font-medium text-wuiSlate-800">Modifications And Interruptions</h2>
                            <p className="pb-6 text-md">We reserve the right to change, modify, or remove the contents
                                of the Site at any time or for any reason at our sole discretion without notice.
                                However, we have no obligation to update any information on our Site. We also reserve
                                the right to modify or discontinue all or part of the Marketplace Offerings without
                                notice at any time. We will not be liable to you or any third party for any
                                modification, price change, suspension, or discontinuance of the Site or the Marketplace
                                Offerings.</p><p className="pb-6 text-md">We cannot guarantee the Site and the
                                Marketplace Offerings will be available at all times. We may experience hardware,
                                ...
                                update, suspend, discontinue, or otherwise modify the Site or the Marketplace Offerings
                                ...
                                use the Site or the Marketplace Offerings during any downtime or discontinuance of the
                                Site or the Marketplace Offerings. Nothing in these Terms of Use will be construed to
                                obligate us to maintain and support the Site or the Marketplace Offerings or to supply
                                any corrections, updates, or releases in connection therewith.</p><h2
                                className="pb-6 text-xl font-medium text-wuiSlate-800">Disclaimer</h2><p
                                className="pb-6 text-md">The site and the marketplace offerings are provided on an as-is
                                and as-available basis. You agree that your use of the site and our services will be at
                                your sole risk. To the fullest extent permitted by law, we disclaim all warranties,
                                express or implied, in connection with the site and the marketplace offerings and your
                                ...
                                or cessation of transmission to or from the site or the marketplace offerings, (5) any
                                ...
                                exercise caution where appropriate.</p><h2
                                className="pb-6 text-xl font-medium text-wuiSlate-800">Limitations Of Liability</h2><p
                                className="pb-6 text-md">In no event will we or our directors, employees, or agents be
                                ...
                                data, or other damages arising from your use of the site or the marketplace offerings,
                                even if we have been advised of the possibility of such damages. Notwithstanding
                                anything to the contrary contained herein, our liability to you for any cause whatsoever
                                and regardless of the form of the action, will at all times be limited to the lesser of
                                ...
                                may not apply to you, and you may have additional rights.</p><h2
                                className="pb-6 text-xl font-medium text-wuiSlate-800">Indemnification</h2><p
                                className="pb-6 text-md">You agree to defend, indemnify, and hold us harmless, including
                                ...
                                of: (1) use of the Marketplace Offerings; (2) breach of these Terms of Use; (3) any
                                breach of your representations and warranties set forth in these Terms of Use; (4) your
                                violation of the rights of a third party, including but not limited to intellectual
                                property rights; or (5) any overt harmful act toward any other user of the Site or the
                                ...
                                indemnification upon becoming aware of it.</p><h2
                                className="pb-6 text-xl font-medium text-wuiSlate-800">User Data</h2><p
                                className="pb-6 text-md">We will maintain certain data that you transmit to the Site for
                                the purpose of managing the performance of the Marketplace Offerings, as well as data
                                relating to your use of the Marketplace Offerings. Although we perform regular routine
                                ...
                                of such data.</p><h2 className="pb-6 text-xl font-medium text-wuiSlate-800">Electronic
                                Communications, Transactions, And Signatures</h2><p className="pb-6 text-md">Visiting
                                ...
                                waive any rights or info-tip under any statutes, regulations, rules, ordinances, or
                                ...
                                means other than electronic means.</p><h2
                                className="pb-6 text-xl font-medium text-wuiSlate-800">Miscellaneous</h2><p
                                className="pb-6 text-md">These Terms of Use and any policies or operating rules posted
                                by us on the Site or in respect to the Marketplace Offerings constitute the entire
                                ...
                                of Use or use of the Marketplace Offerings. You agree that these Terms of Use will not
                                ...
                                signing by the parties hereto to execute these Terms of Use.</p><h2
                                className="pb-6 text-xl font-medium text-wuiSlate-800">Contact Us</h2><p
                                className="pb-12 text-md">In order to resolve a complaint regarding the Site or the
                                Marketplace Offerings or to receive further information regarding use of the Site or the
                                Marketplace Offerings, please contact us at <a href="mailto:emami8637@gmail.com"
                                                                                       aria-label="Contact webvave link"
                                                                                       target="blank"
                                                                                       className="text-emerald-500">emami8637@gmail.com</a>
                            </p><p className="text-sm font-medium">Updated at 31 Oct 2023</p></div>
                    </div>
                </div>
            </section>
        </main>
