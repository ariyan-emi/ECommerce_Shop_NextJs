                ...
                <div className="px-6 py-4 md:py-7 lg:pt-14 xl:pb-6">
                    ...
                    <div className="mt-8 md:mt-10">
                        <nav className="flex flex-wrap justify-center text-lg font-medium">
                            ...
                            <div className="px-5 py-2"><a href="https://github.com/ariyan-emi">GitHub</a></div>
                            <div className="px-5 py-2"><a href="https://linkedin.com/in/ariyan-emami-8b99a3251">Linkedin</a></div>
                        </nav>
